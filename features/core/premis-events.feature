...
Feature: PREMIS events are recorded correctly
  ...
  Scenario: Isla wants to confirm that standard PREMIS events are created
    ...
    And the processing config decision "Perform file format identification (Transfer)" is set to "No"
    ...
    And the processing config decision "Perform file format identification (Ingest)" is set to "No, use existing data"
    ...
    And the processing config decision "Perform file format identification (Submission documentation & metadata)" is set to "No"
