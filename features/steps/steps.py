...
def step_impl(context):
    ...
    context.execute_steps(
        ...
        ' "Yes"\n'
        'And the processing config decision "Perform file format'
        ' identification (Submission documentation & metadata)" is set'
        ' to "No"\n'
...
def step_impl(context):
    ...
    context.execute_steps(
        ...
        'And the user waits for the "Do you want to perform file format'
        ' identification?" decision point to appear and chooses "No"'
        ' during transfer\n'
        ...
        ' ingest\n'
        'And the user waits for the "Do you want to perform file format'
        ' identification?|Process submission documentation" decision point'
        ' to appear and chooses "No" during ingest\n'
